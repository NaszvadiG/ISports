...
<div id="container" class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div id="page-content" class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <div class="list-group relation-search-list">
                        <?php foreach ($rs as $r){?>
                        <a href="#" class="list-group-item friend-info" value="<?php echo $r->id?>">
                    ...
                    <div class="col-md-12">
                        <button id="button-add-friend" class="btn btn-success col-md-12" value="-1">加为好友</button>
                    </div>
                </div>
            </div>
        </div>
